class Api {
  ...
  setSettings() {
    chrome.storage.sync.set(window.settings.settings);
    this.setSettingsTime = $.now();
  }
  ...
  allNPCInCorner(){
   ...
   findNearestBox() {
    ...
    if (!window.settings.settings.bonusBox && !window.settings.settings.materials && !window.settings.settings.palladium && !window.settings.settings.cargoBox && !window.settings.settings.greenOrGoldBooty && !window.settings.settings.redBooty && !window.settings.settings.blueBooty && !window.settings.settings.masqueBooty) {
      return {
        box: null,
        distance: minDist
      };
